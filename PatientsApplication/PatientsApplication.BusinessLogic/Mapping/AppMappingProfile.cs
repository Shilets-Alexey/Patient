    ...
    public class AppMappingProfile : Profile
    {
        public AppMappingProfile()
        {
            ...
            CreateMap<Patient, PatientDto>()
                ...
                .ForMember(dest => dest.BirthDate, opt => opt.MapFrom(patient => patient.BirthDate.ToLocalTime()))
            ...
            CreateMap<PatientDto, Patient>()
                ...
                .ForMember(dest => dest.BirthDate, opt => opt.MapFrom(patient => patient.BirthDate.ToUniversalTime()))
